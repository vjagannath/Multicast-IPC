...
#define PM_MSEND			(PM_BASE + 48)
#define PM_MRECEIVE			(PM_BASE + 49)
#define PM_OPENGROUP		(PM_BASE + 50)
#define PM_CLOSEGROUP		(PM_BASE + 51)
#define PM_RECOVERGROUP		(PM_BASE + 52)
#define PM_GETGROUPINFO		(PM_BASE + 53)
